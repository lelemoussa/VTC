              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">CHAUFFEURS</div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">VOITURES</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $voitures }}</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
